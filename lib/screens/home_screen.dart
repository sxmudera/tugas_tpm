...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final menus = [
      ...
      ('Total Angka',    const JumlahScreen()),
      ('Stopwatch',      const StopwatchScreen()),
      ('Piramid',        const PiramidScreen()),
    ];
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Text('Keluar',
                          style: TextStyle(
                              fontSize: 12, fontWeight: FontWeight.w600, color: kHitam)),
                    ),
                  ),
                ],
              ),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Icon(Icons.arrow_forward_ios, size: 14, color: kAbu),
                      ],
                    ),
                  ),
                ),
